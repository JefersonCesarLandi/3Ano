 ...
 */
@Entity
@Table(name = "clientes", catalog = "sysvendas", schema = "")
@NamedQueries({
    ...
    , @NamedQuery(name = "Clientes.findByEndere\u00e7o", query = "SELECT c FROM Clientes c WHERE c.endere\u00e7o = :endere\u00e7o")
...
public class Clientes implements Serializable {
    ...
    public void setEndereco(String endereco) {
        ...
        this.endereco = endereco;
        changeSupport.firePropertyChange("endere\u00e7o", oldEndereco, endereco);
    }
    ...
    public String toString() {
        return "AulaBD02.Clientes[ id=" + id + " ]";
    }
